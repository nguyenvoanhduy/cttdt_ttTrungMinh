...
export const PublicLibraryPage = () => {
  const [activeTab, setActiveTab] = useState<'books' | 'music' | 'videos'>('books');
    ...
    <div className="animate-in fade-in duration-500">
      ...
      <div className="container mx-auto px-6 md:px-12 py-12">
        ...
        <div className="flex justify-center mb-12">
            <div className="flex flex-wrap justify-center gap-4 md:space-x-8 border-b border-gray-200 px-4">
                 <button 
                    onClick={() => setActiveTab('books')}
                    className={`pb-4 px-2 text-lg font-medium border-b-2 transition-colors flex items-center gap-2 ${
                        activeTab === 'books' ? 'border-blue-600 text-blue-600' : 'border-transparent text-gray-500 hover:text-gray-800'
                    }`}
                 >
                 ...
                 <button 
                    ...
                    className={`pb-4 px-2 text-lg font-medium border-b-2 transition-colors flex items-center gap-2 ${
                        activeTab === 'music' ? 'border-blue-600 text-blue-600' : 'border-transparent text-gray-500 hover:text-gray-800'
                    }`}
                 >
                 ...
                 <button 
                    ...
                    className={`pb-4 px-2 text-lg font-medium border-b-2 transition-colors flex items-center gap-2 ${
                        activeTab === 'videos' ? 'border-blue-600 text-blue-600' : 'border-transparent text-gray-500 hover:text-gray-800'
                    }`}
                 >
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6">
                {MOCK_BOOKS.map(book => (
                    <div 
                        ...
                        className="group relative bg-white p-4 rounded-xl shadow-sm hover:shadow-xl border border-gray-100 transition-all cursor-pointer top-0 hover:-top-1"
                    >
                        <div className="aspect-[3/4] bg-gray-50 rounded-lg mb-4 flex items-center justify-center relative overflow-hidden border border-gray-100">
                             {/* Mock Book Cover */}
                             ...
                             <div className="absolute inset-0 bg-blue-900/80 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity backdrop-blur-sm">
                        ...
                        <h4 className="font-bold text-gray-800 text-sm line-clamp-2 mb-2 h-10 group-hover:text-blue-600 transition-colors">{book.title}</h4>
                ...
                {MOCK_SONGS.map((song, idx) => (
                    ...
                    >
                        <div className="relative w-20 h-20 flex-shrink-0">
                            <img src={song.coverImageUrl} alt={song.title} className="w-full h-full object-cover rounded-lg shadow-sm" />
              ...
              <div className="bg-white w-full max-w-5xl h-[85vh] rounded-2xl flex flex-col overflow-hidden shadow-2xl">
                  ...
                  <div className="h-16 bg-gray-900 text-white flex items-center justify-between px-6 shrink-0">
                      ...
                      <div className="flex items-center gap-4">
                          <button className="p-2 hover:bg-gray-700 rounded-full"><Icons.Download className="w-5 h-5" /></button>
                  ...
                  <div className="flex-1 bg-gray-100 overflow-y-auto p-8 flex justify-center">
                      <div className="bg-white shadow-xl w-full max-w-3xl min-h-full p-12 text-gray-800">
                          ...
                          <div className="space-y-4 text-justify leading-relaxed font-serif">
                                ...
                                <p>
                                    Đại Đạo Tam Kỳ Phổ Độ là một nền tôn giáo lớn, có tôn chỉ, mục đích rõ ràng, 
                                    nhằm quy nguyên tam giáo, hiệp nhất ngũ chi, phục nhất nhân tâm, 
                                    tạo thế giới đại đồng.
                                </p>
                                <p>
                                    Tài liệu này được biên soạn nhằm giúp quý đạo hữu và độc giả gần xa 
                                    hiểu rõ hơn về những giáo lý căn bản, những quy điều và luật pháp 
                                    của Đạo, từ đó tu tâm dưỡng tánh, sống tốt đời đẹp đạo.
                                </p>
                                <p className="text-gray-400 italic text-center py-12">[Nội dung tài liệu đang được tải...]</p>
                                <p>
                                    (Đây là bản xem thử mô phỏng. Trong thực tế, phần này sẽ hiển thị nội dung PDF hoặc DOCX đầy đủ của tài liệu.)
                                </p>
                          </div>
                      </div>
                  </div>
      ...
      {playingSong && (
           <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/90 backdrop-blur-md animate-in fade-in duration-300">
               ...
               <div className="flex flex-col md:flex-row items-center gap-12 max-w-4xl w-full">
                    {/* Cover Art */}
                    <div className="w-64 h-64 md:w-96 md:h-96 rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.5)] overflow-hidden relative group">
                    ...
                    <div className="flex-1 w-full text-center md:text-left text-white">
                         ...
                         <div className="mb-8 group">
                             ...
                             <div className="flex justify-between text-xs text-gray-400 mt-2 font-mono">
                                 <span>{Math.floor((progress / 100) * playingSong.duration / 60)}:{String(Math.floor((progress / 100) * playingSong.duration % 60)).padStart(2, '0')}</span>
                                 <span>{Math.floor(playingSong.duration / 60)}:{String(playingSong.duration % 60).padStart(2, '0')}</span>
                             </div>
                         </div>
