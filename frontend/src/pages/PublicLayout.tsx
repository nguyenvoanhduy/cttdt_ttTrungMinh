            ...
            {isAuthenticated ? (
               <div className="relative hidden md:block" ref={dropdownRef}>
                  ...
                  >
                      ...
                      />
                      <span className="text-sm font-medium text-gray-700 max-w-[100px] truncate">{personal?.fullname}</span>
           ...
           <div>
               <div className="flex items-center gap-2 mb-6">
                   <div className="w-8 h-8 rounded-2xl flex items-center justify-center bg-transparent overflow-hidden">
                        <img src="../../public/logoThanhThat.png" className="w-full h-full object-cover"/>
                   </div>
               ...
               <div className="flex gap-4">
                   <a href="https://www.facebook.com/GiaDinhHungDaoTrungMinh" className="w-8 h-8 rounded-full bg-gray-800 flex items-center justify-center hover:bg-blue-600 hover:text-white transition-colors"><Icons.Facebook className="w-4 h-4" /></a>
                   <a href="#" className="w-8 h-8 rounded-full bg-gray-800 flex items-center justify-center hover:bg-red-500 hover:text-white transition-colors"><Icons.Youtube className="w-4 h-4" /></a>
               </div>
           </div>
           ...
           <div>
               ...
               <ul className="space-y-4 text-sm">
                   <li className="flex items-start">
                       ...
                       <span>609-611 Đ. Bình Thới, Phường 10, Quận 11, Thành phố Hồ Chí Minh, Việt Nam</span>
                   </li>
