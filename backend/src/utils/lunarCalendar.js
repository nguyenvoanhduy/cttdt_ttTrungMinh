...
function sunLongitude(jdn) {
  const T = (jdn - 2451545.0) / 36525; // Time in Julian centuries
  const T2 = T * T;
  ...
  L = L - 360 * Math.floor(L / 360); // Normalize to (0, 360)
  return L;
}

// Tính số ngày Julius của ngày có kinh độ mặt trời là 0
...
// Tìm số ngày Julius của ngày mùng 1 tháng 11 năm âm lịch
...
// Tìm số ngày Julius của tháng âm lịch có chứa ngày dương lịch
